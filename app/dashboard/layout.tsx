...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { label: "Pays", href: "/dashboard/countries", icon: "🌍", roles: ["ADMIN", "APPLICATION"] },
    { label: "Universites", href: "/dashboard/universities", icon: "🏛", roles: ["ADMIN", "APPLICATION", "CONSULTANT", "SUB_AGENT"] },
    { label: "Recherche Programme", href: "/dashboard/search-programs", icon: "🔍", roles: ["CONSULTANT", "SUB_AGENT"] },
    { label: "Programmes", href: "/dashboard/programs", icon: "📚", roles: ["ADMIN", "APPLICATION"] },
